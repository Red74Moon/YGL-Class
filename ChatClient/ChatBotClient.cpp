// ChatBot_Client.cpp : This file contains the 'main' function. 
// Program execution begins and ends there.
// 
// url :: https://gist.github.com/TechTalk-DataStructures/fb61b6d13ad5820bc389af1d5ff8abb8
//
...
void Client()
{
    ...
    TCPServerAdd.sin_port = htons(9190);
    ...
    std::cout << "How do we call you, Your name please!" << std::endl;
    std::cout << "My Name : ";
